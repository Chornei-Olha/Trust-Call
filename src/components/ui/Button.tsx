...
const Button: React.FC<ButtonProps & React.ButtonHTMLAttributes<HTMLButtonElement>> = ({ 
  ...
  const variants = {
    primary: 'bg-brand text-white hover:bg-accent-primary active:bg-accent-secondary focus:ring-brand',
    secondary: 'bg-button text-button hover:bg-gray-light active:bg-cream focus:ring-gray-light',
    outline: 'border border-gray-light text-medium bg-transparent hover:bg-light-gray active:bg-cream focus:ring-gray-light',
    ghost: 'text-medium bg-transparent hover:bg-light-gray active:bg-cream focus:ring-gray-light',
    danger: 'bg-red-600 text-white hover:bg-red-700 active:bg-red-800 focus:ring-red-500',
    brand: 'bg-brand text-white hover:bg-accent-primary active:bg-accent-secondary focus:ring-brand'
  };
