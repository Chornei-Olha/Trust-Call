  ...
  return (
    <section className="w-full bg-black py-16 sm:py-20 md:py-24 lg:py-32">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div key={index} className="relative">
              <div className="relative bg-[#0000004c] border border-white/40 rounded-[32px] sm:rounded-[40px] p-6 sm:p-8 shadow-2xl">
                ...
                <div className="space-y-6">
                  <h3 className="text-[18px] sm:text-[20px] font-bold text-white whitespace-pre-line">
                    {benefit.title}
                  </h3>
        ...
        <div
          className="rounded-[24px] p-6 sm:p-8 md:p-12 bg-cover bg-center max-h-[288px] h-[288px]"
