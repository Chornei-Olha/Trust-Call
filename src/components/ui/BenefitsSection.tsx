...
const benefits = [
  ...
  {
    title: 'Показники апруву на рівні 85 %',
    description:
      'Штат компанії нараховує понад 200 професійних менеджерів та чіткий алгоритм розподілення навантаження між кожною ланкою, ми телефонуємо 12-14 разів/добу застиглі ліди, що гарантує високий показник Апруву',
    icon: '/images/v3.svg',
  },
  {
    title: 'Високий Up-sell та Cross-sell',
    description:
      "Завдяки нашим спеціалістам із написання скриптів, Ви можете розраховувати на 81%+ допродажів 'повітря' з гарним викупом. В 50%+ замовлень ми допродаємо додаткові товари з ринковою маржею для ння Вашої прибутковості",
    icon: '/images/v1.svg',
  },
  {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12 items-center relative">
              <div className="lg:col-span-2 space-y-6">
                ...
                <p className="text-[15px] font-regular font-inter text-black/50 leading-relaxed">
                  Завдяки наявному генератору та Starlink, ми працюємо у повному автономному режимі,
                  і навіть під час повного блек-ауту зможемо обробляти ліди. Ми на зв'язку 24/7 та
