...
const benefits = [
  ...
  },
  {
    ...
    description:
      "Завдяки нашим спеціалістам із написання скриптів, Ви можете розраховувати на 81%+ допродажів 'повітря' з гарним викупом. В 50%+ замовлень ми допродаємо додаткові товари з ринковою маржею для підвищення Вашої прибутковості",
    icon: '/images/v1.svg',
  },
  {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12 items-center relative">
              <div className="lg:col-span-2 space-y-6">
                ...
                <p className="text-[15px] font-regular font-inter text-black/50 leading-relaxed">
                  Завдяки наявному гератору та Starlink, ми працюємо у повному автономному режимі, і
