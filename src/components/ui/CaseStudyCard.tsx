        ...
        <div className="space-y-0">
          ...
          <div className="bg-[#efeae4] rounded-[10px] p-3 space-y-3">
            <div className="flex justify-between items-center">
              ...
              <span className="text-[14px] font-bold text-black">{study.beforeStats.approval}</span>
              <span className="text-[14px] font-bold text-black">{study.afterStats.approval}</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-[15px] text-black">Upsell</span>
              <span className="text-[13px] font-bold text-black">{study.beforeStats.upsell}</span>
              <span className="text-[13px] font-bold text-black">{study.afterStats.upsell}</span>
            </div>
            <div className="flex justify-between items-center">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-[13px] font-bold text-black">{study.beforeStats.buyout}</span>
              <span className="text-[13px] font-bold text-black">{study.afterStats.buyout}</span>
            </div>
          </div>

          <Button variant="brand" size="lg" fullWidth className="text-[20px] font-bold text-white">
            РАЗОМ
          </Button>
          ...
          <div className="text-left space-y-1 px-3 py-5">
            ...
            <p className="text-[14px] font-medium text-[#404040]">
              ...
              <span className="text-[#1663d3] font-semibold">{study.results.dailyEarnings}</span>
            </p>
            <p className="text-[14px] font-medium text-[#404040]">
              <span>Додатковий прибуток: </span>
              <span className="text-[#1663d3] font-semibold">{study.results.monthlyProfit}</span>
            </p>
          </div>
